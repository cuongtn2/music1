            ...
            <div className={`w-full items-center gap-3 p-4 flex relative`}>
                ...
                <div className='flex items-start flex-col'>
                    ...
                    <p className='text-textColor'>
                        ...
                        <span className='text-sm text-darkOverlay font-semibold'>
                            ({allSongs[songIndex]?.catrgory})
                        </span>
                    </p>

                    {/* icon funtion playlist */}
                    <motion.i 
                        whileTap={{ scale : 0.8}}
                        onClick={() => setIsPlayList(!isPlayList)}
                    >
                        <RiPlayListFill className='text-darkOverlay hover:text-headingColor text-3xl cursor-pointer' />
